...
description: "Utility functions for value conversion, type assertions, JID resolution, async helpers, and shared constants exported from the WABotJS Utils namespace."
---
