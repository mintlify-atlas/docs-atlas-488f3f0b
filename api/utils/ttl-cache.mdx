---
title: "Utils.TTLCache — In-Memory Cache with Time-to-Live Expiry"
sidebarTitle: "TTLCache"
description: "TTLCache is a generic in-memory cache where every entry carries an expiry timestamp, with automatic background cleanup and expiry filtering on bulk reads."
---
