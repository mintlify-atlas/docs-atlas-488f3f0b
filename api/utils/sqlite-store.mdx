---
title: "Utils.SQLiteStore — TTL-Aware Persistent Key-Value Store"
sidebarTitle: "SQLiteStore"
description: "SQLiteStore is a Uint8Array-valued persistent key-value store backed by node:sqlite with an optional row-level TTL and a 10-minute in-memory L1 read cache."
---
