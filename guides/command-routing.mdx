---
title: "Building Prefix-Based Command Handlers with WABotJS"
sidebarTitle: "Command Routing"
description: "Use the onCommand callback to automatically parse a prefix, command name, and argument list from incoming messages and build structured bot commands."
---
